...
module LCD_display_string(index,out,hex0,hex1);
   ...
   always 
     case (index)
		 5'h00: out <= hex0[127:120];
		 5'h01: out <= hex0[119:112];
		 5'h02: out <= hex0[111:104];
		 5'h03: out <= hex0[103:96];
		 5'h04: out <= hex0[95:88];
		 5'h05: out <= hex0[87:80];
		 5'h06: out <= hex0[79:72];
		 5'h07: out <= hex0[71:64];
		 5'h08: out <= hex0[63:56];
		 5'h09: out <= hex0[55:48];
		 5'h0A: out <= hex0[47:40];
		 5'h0B: out <= hex0[39:32];
		 5'h0C: out <= hex0[31:24];
		 5'h0D: out <= hex0[23:16];
		 5'h0E: out <= hex0[15:8];
		 5'h0F: out <= hex0[7:0];

		// Line 2
		 5'h10: out <= hex1[127:120];
		 5'h11: out <= hex1[119:112];
		 5'h12: out <= hex1[111:104];
		 5'h13: out <= hex1[103:96];
		 5'h14: out <= hex1[95:88];
		 5'h15: out <= hex1[87:80];
		 5'h16: out <= hex1[79:72];
		 5'h17: out <= hex1[71:64];
		 5'h18: out <= hex1[63:56];
		 5'h19: out <= hex1[55:48];
		 5'h1A: out <= hex1[47:40];
		 5'h1B: out <= hex1[39:32];
		 5'h1C: out <= hex1[31:24];
		 5'h1D: out <= hex1[23:16];
		 5'h1E: out <= hex1[15:8];
		 5'h1F: out <= hex1[7:0];
		 default: out <= 8'h20;
     endcase
